...
## Висновок
Я навчився застосовувати методи класу та статичний метод. Зрозумів різницю між типами методів та практичне застосування альтернативних конструкторів для ініціалізації об'єктів.
