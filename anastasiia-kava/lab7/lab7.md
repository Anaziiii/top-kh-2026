...
Реалізовано методи класу та статичний метод. Опановано різницю між типами методів та практичне застосування альтернативних конструкторів для ініціалізації об'єктів.