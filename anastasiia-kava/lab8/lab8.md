...
1. *Взятий минулий клас Phone, який об'єднує спільні характеристики пристроїв. Використано змінну класу `how_many` для глобального підрахунку всіх створених об'єктів ієрархії, а доступ до неї реалізовано через метод класу*
